...
server.registerTool("list_open_merge_requests", {
...
server.registerTool("get_merge_request_details", {
...
server.registerTool("get_merge_request_comments", {
...
server.registerTool("add_merge_request_comment", {
...
server.registerTool("add_merge_request_diff_comment", {
...
server.registerTool("get_merge_request_diff", {
...
server.registerTool("set_merge_request_description", {
...
server.registerTool("set_merge_request_title", {
